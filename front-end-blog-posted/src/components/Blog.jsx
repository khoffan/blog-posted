...
export default function Blog({
  ...
  return (
    <>
      {isUser == false ? (
        <div className="z-10 block mx-auto max-w-[700px] h-[250px] border rounded-md p-[10px] mb-[10px] shadow-md hober:outline-offset-0 hover:outline">
        ...
        <div className="z-10 relative block mx-auto max-w-[700px] min-h-[250px] border rounded-md p-[10px] mb-[10px] shadow-md hover:outline-offset-0 hover:outline">
